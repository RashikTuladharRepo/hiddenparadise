<html>
	<head>
		...
		<link  rel="stylesheet" type="text/css" href="<?php echo base_url('styles/hiddencustom.css'); ?>"/>
		<link  rel="stylesheet" type="text/css" href="<?php echo base_url('styles/font-awesome.css'); ?>"/>

		    <!-- get jQuery from the google apis -->
   		 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.js"></script>

		<link  rel="stylesheet" href="<?php echo base_url('styles/settings.css');?>" media="screen"/>
		<link  rel="stylesheet" href="<?php echo base_url('styles/style.css'); ?>" media="screen"/>
			<!-- GOOGLE FONTS -->
  ...
  <div class="tp-banner-container">
		<div class="tp-banner" >
			<ul>	<!-- SLIDE  -->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url('images/slidebg1.jpg');?>"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption customin customout"
						...
						data-endspeed="500"
						data-endeasing="Power4.easeIn"
						style="z-index: 3"><img src="<?php echo('images/woman.png');?>" alt="">
					</div>
					...
					<div class="tp-caption skewfromrightshort customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 9"><img src="<?php echo('images/graph.png');?>" alt="" data-ww="52" data-hh="44">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 16"><img src="<?php echo('images/star.png');?>" alt="" data-ww="20" data-hh="20">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 17"><img src="<?php echo('images/star.png');?>" alt="" data-ww="20" data-hh="20">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 18"><img src="<?php echo('images/star.png');?>" alt="" data-ww="20" data-hh="20">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 19"><img src="<?php echo('images/star.png');?>" alt="" data-ww="20" data-hh="20">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						data-endeasing="Power4.easeIn"
						data-captionhidden="on"
						style="z-index: 20"><img src="<?php echo('images/star.png');?>" alt="" data-ww="20" data-hh="20">
					</div>
				...
				<li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
					<!-- MAIN IMAGE -->
					<img src="<?php echo('images/darkblurbg.jpg');?>"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption customin"
						...
						data-endspeed="300"
						style="z-index: 2"><img src="<?php echo('images/macbook2.png');?>" alt="">
					</div>
					...
					<div class="tp-caption customin"
						...
						data-easing="Power3.easeInOut"
						data-endspeed="300"
						style="z-index: 3"><img src="<?php echo('images/imac1.png');?>" alt="">
					</div>
					...
					<div class="tp-caption customin"
						...
						data-easing="Power3.easeInOut"
						data-endspeed="300"
						style="z-index: 4"><img src="<?php echo('images/lupe_macbook.png');?>" alt="">
					</div>
					...
					<div class="tp-caption customin"
						...
						data-easing="Power3.easeInOut"
						data-endspeed="300"
						style="z-index: 5"><img src="<?php echo('images/lupe_imac.png')?>" alt="">
					</div>
	...
	<div style="width: 100%;height:800px;background:red">
		...
		<script type="text/javascript" src="<?php echo base_url('scripts/jquery.themepunch.plugins.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('scripts/jquery.themepunch.revolution.min.js'); ?>"></script>
